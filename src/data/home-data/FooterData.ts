...
const footer_data: DataType[] = [
   ...
   },
   {
      ...
      widget_title: "Legal",
      footer_link: [
         { link: "/terms", link_title: "Términos & Condiciones" },
         { link: "/cookie", link_title: "Cookie" },
         { link: "/privacy", link_title: "Política de Privacidad" }
      ]
   },
   {
      id: 3,
      ...
      footer_link: [{ link: "/properties", link_title: "Ver Propiedades" }]
   },
